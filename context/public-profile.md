...
这句话不是“所有人都要创业”，而是希望人的一些重要判断和手艺能进入现实，接受使用、反驳、拒绝与时间的检验，并逐渐形成作者愿意长期负责的作品。

## 他反复处理的问题

- 工具变化以后，什么仍然值得学、值得做；
- 如何把 world model、实验与真实反馈变成更好的判断；
- AI 如何改变成本与能力边界，以及哪些旧工作方式需要重新求解；
- 怎样从任务、产出和内部记分牌走向对用户与结果负责；
- 如何把手艺、市场、产品与杠杆连接起来；
- 内容、分发、社区和组织环境如何帮助真实作品遇到现实。
...
这是一份面向检索的简洁公开简介，不是履历证明文件。需要使用具体数字、合作关系或当前产品事实时，应回到对应公开页面核验当时状态。
