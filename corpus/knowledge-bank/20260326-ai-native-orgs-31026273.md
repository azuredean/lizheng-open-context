...
> 原文：[AI Native 的组织形态：当执行成本下降，组织必须重写](https://www.superlinear.academy/c/ai-resources/ai-native-orgs) · 发布于 2026-03-26。许可不覆盖文中的第三方引文、访谈发言、链接与商标。
...
这是 [@陈然](https://www.superlinear.academy/u/8262a3a1) 的观察：全职员工按时间付薪，而不是按实际产出付薪。
